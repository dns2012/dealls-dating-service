...
func (m *RegisterRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetFullName()) < 5 {
	...
	if utf8.RuneCountInString(m.GetBirthDate()) < 8 {
		err := RegisterRequestValidationError{
			field:  "BirthDate",
			reason: "value length must be at least 8 runes",
		}
	...
	if !_RegisterRequest_BirthDate_Pattern.MatchString(m.GetBirthDate()) {
		err := RegisterRequestValidationError{
			field:  "BirthDate",
	...
	if _, ok := _RegisterRequest_Gender_InLookup[m.GetGender()]; !ok {
		err := RegisterRequestValidationError{
			field:  "Gender",
	...
	if utf8.RuneCountInString(m.GetCompany()) < 5 {
		err := RegisterRequestValidationError{
			field:  "Company",
			reason: "value length must be at least 5 runes",
		}
	...
	if utf8.RuneCountInString(m.GetJobTitle()) < 5 {
		err := RegisterRequestValidationError{
			field:  "JobTitle",
			reason: "value length must be at least 5 runes",
		}
...
var _RegisterRequest_BirthDate_Pattern = regexp.MustCompile("^\\d{4}-\\d{2}-\\d{2}$")

var _RegisterRequest_Gender_InLookup = map[Gender]struct{}{
	1: {},
	2: {},
}

// Validate checks the field values on AuthResponseData with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *AuthResponseData) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AuthResponseData with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AuthResponseDataMultiError, or nil if none found.
func (m *AuthResponseData) ValidateAll() error {
	return m.validate(true)
}

func (m *AuthResponseData) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AuthResponseDataMultiError(errors)
	}

	return nil
}

// AuthResponseDataMultiError is an error wrapping multiple validation errors
// returned by AuthResponseData.ValidateAll() if the designated constraints
// aren't met.
type AuthResponseDataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AuthResponseDataMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AuthResponseDataMultiError) AllErrors() []error { return m }

// AuthResponseDataValidationError is the validation error returned by
// AuthResponseData.Validate if the designated constraints aren't met.
type AuthResponseDataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AuthResponseDataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AuthResponseDataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AuthResponseDataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AuthResponseDataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AuthResponseDataValidationError) ErrorName() string { return "AuthResponseDataValidationError" }

// Error satisfies the builtin error interface
func (e AuthResponseDataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAuthResponseData.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AuthResponseDataValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AuthResponseDataValidationError{}
